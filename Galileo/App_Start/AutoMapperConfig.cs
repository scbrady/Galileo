    ...
    public class AutoMapperConfig
    {
        public static void RegisterMappings()
        {
            AutoMapper.Mapper.CreateMap<Course, Module>()
                ...
                .ForMember(dest => dest.hours_per_day, opts => opts.MapFrom(src => src.course_total_hours))
                .ForMember(dest => dest.hours_per_week, opts => opts.MapFrom(src => src.course_total_hours));
            ...
            AutoMapper.Mapper.CreateMap<Project, Module>()
                ...
                .ForMember(dest => dest.hours_per_day, opts => opts.MapFrom(src => src.project_total_hours))
                .ForMember(dest => dest.hours_per_week, opts => opts.MapFrom(src => src.project_total_hours));
